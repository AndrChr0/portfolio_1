...
function Projects() {
  return (
    <main>
      <h1 tabIndex={0} className="project-heading">Projects</h1>
      <div className="project-container">
        <div className="project-card">
          <div className="project-left">
            <h2 tabIndex={0}>Scrollytelling - Deforestation</h2>
            <img tabIndex={0} src="./scrolly-telling.png" alt="a forest from above, with the title 'Deforestation' in fron of it" />
          </div>
        ...
        <div className="project-card">
          <div className="project-left">
            <h2 tabIndex={0}>Fully Accessible website</h2>
            <img tabIndex={0} src="./climbing-wall-project.png" alt="The Gjøvik Climbing wall homepage, with different text and images detailing the climbing facilities" />
          </div>
          ...
          <div className="project-right">
            <p tabIndex={0}>
              ...
              project, I gained a deep understanding of the <abbr title="Web Content Accessibility Guidelines">WCAG</abbr> 2.1 guidelines
              and how to apply them effectively to such a project. Additionally,
              I gained direct insight into what it is like to navigate the web
        ...
        <div className="project-card">
          <div className="project-left">
            <h2 tabIndex={0}>Darling Student Union Website</h2>
            <img tabIndex={0} src="./darling.png" alt="The homepage of the Darling student Union homepage with images of students doing different activities" />
          </div>
