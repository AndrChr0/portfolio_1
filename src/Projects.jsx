...
function Projects() {
  return (
    <main>
      <div className='lg:w-[70%] lg:my-0 lg:mx-auto'>
          ...
          <div className='project-card'>
            ...
            <div className='project-right'>
              <p tabIndex={0}>
                ...
                focused on the effects of deforestation. We split the page in
                two, with a forest on the left and a city on the right, to show
                how the growth of society affects the rainforests. We employed
                Sass to utilize more advanced CSS functionalities and the
                Intersection Observer API to create dynamic changes as the user
                scrolls.
              </p>
          ...
          <div className='project-card'>
            ...
            <div className='project-right'>
              <p tabIndex={0}>
                ...
                2.1 guidelines and how to apply them effectively to such a
                project. Additionally, I gained direct insight into what it is
                like to navigate the web as a user with disabilities.
              </p>
              <div className='project-links'>
                <a
                  className='underline'
