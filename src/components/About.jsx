function About() {
  return (
    <div
      id='about'
      tabIndex={0}
      className='w-11/12 h-1/2 lg:h-1/2 md:w-9/12 lg:w-[70ch] my-0 mx-auto pt-16'
    >
      <h2 className='font-light text-2xl md:text-3xl lg:text-4xl'>About Me</h2>
      ...
      <p className='pt-4 pl-2 md:pl-4 font-light text-lg md:text-2xl lg:text-2xl leading-normal'>
        ...
        fundamental web technologies. Outside of school, I am an avid climber
        and an active member in various student unions.
      </p>
    </div>
  );
}
